...
# Insert EventCard before Colosseum component
...
# Replace the gallery grid with the stack scroll
content = re.sub(r'\{/\* EVENTS SECTION - NEOCLASSICAL GALLERY \*/\}.*?</section>', events_section_new, content, flags=re.DOTALL)
