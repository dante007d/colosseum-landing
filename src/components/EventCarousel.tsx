      ...
      >
        ...
        <div className="flex items-center justify-center gap-12 mt-16">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" className="w-6 h-6 stroke-current fill-none relative z-10 transition-transform group-hover:-translate-x-1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
