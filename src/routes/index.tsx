...
function FloatingArtifacts({ scrollY }: { scrollY: any }) {
...
function Colosseum() {
  ...
  if (showIntro) {
    return (
      <div className={`fixed inset-0 z-[100] bg-ash flex items-center justify-center transition-opacity duration-1000 ${isExiting ? "opacity-0" : "opacity-100"}`}>
        <video ref={videoRef} autoPlay playsInline onEnded={handleIntroComplete} className="w-full h-full object-cover">
  ...
  return (
    <div className="relative min-h-screen selection:bg-gold/30 selection:text-gold">
      ...
      <ScrollProgress />
      <nav className="fixed top-0 inset-x-0 z-[100] backdrop-blur-md border-b border-gold/20" style={{ background: "oklch(0.10 0.01 60 / 0.95)" }}>
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          <a href="#" className="font-display font-black text-gold-gradient tracking-[0.2em] text-base md:text-lg hover:brightness-125 transition-all">⚔ COLOSSEUM</a>
            ...
            {NAV.map((n) => (
              <li key={n.href}>
                <Magnetic strength={0.2}>
                  <a href={n.href} className="font-heading text-[0.65rem] tracking-[0.4em] uppercase text-parchment/60 hover:text-gold transition-colors">
                    {n.label}
                  </a>
                </Magnetic>
              </li>
        ...
        {/* Mobile Menu Overlay */}
        <div className={`fixed inset-0 bg-ash/95 backdrop-blur-xl z-[105] transition-all duration-500 md:hidden ${mobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none translate-x-full"}`}>
          <div className="marble-texture" />
      ...
      <header className="relative h-screen overflow-hidden flex items-center justify-center">
        ...
        <Particles />
        <motion.div style={{ y: heroParallax, opacity: heroOpacity }} className="relative z-20 text-center px-6 w-full max-w-none">
          ...
          <div className="py-8 overflow-hidden">
            <h1 className="font-display text-imperial text-gold-gradient leading-[1.1] pb-8 px-4 flex justify-center flex-wrap gap-x-1 md:gap-x-2" 
      ...
      <section className="relative py-40 px-6 overflow-hidden bg-ash">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            >
              <p className="font-body italic text-parchment drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]" style={{ fontSize: "clamp(1.6rem, 4vw, 3.5rem)", lineHeight: 1.3 }}>
              ...
              />
              <p className="font-heading text-gold/90 tracking-[0.6em] text-[0.8rem] uppercase mt-10">The Philosophy of Colosseum</p>
            </motion.div>
          </div>
      </section>
      ...
      <section id="about" className="relative py-32 md:py-48 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center border-x border-gold/10 px-8 md:px-20 relative">
          ...
          >
            <p className="font-heading text-gold tracking-[0.5em] text-[0.8rem] uppercase mb-6">The Legacy</p>
            <h2 className="font-display text-gold-gradient mb-10" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>About the Festival</h2>
          ...
          <TsunamiEffect>
            ...
            >
              ...
              <div className="absolute inset-0 z-20 pointer-events-none overflow-hidden">
                 <div className="w-[200%] h-full bg-gradient-to-r from-transparent via-gold/15 to-transparent -translate-x-full" 
              ...
              <img src="/logo.png" alt="BEC Creative Spectrum" className="w-full h-full object-cover relative z-10 transition-transform duration-1000 group-hover:scale-105" />
            </motion.div>
          </TsunamiEffect>
        </div>
      </section>
